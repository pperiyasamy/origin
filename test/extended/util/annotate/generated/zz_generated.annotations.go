...
var Annotations = map[string]string{
	...
	"[sig-network][Feature:IPsec] when using openshift ovn-kubernetes ensure traffic between local pod to a remote pod is IPsec encrypted when IPsecMode configured in Full mode [apigroup:config.openshift.io] [Suite:openshift/network/ipsec]": "",

	"[sig-network][Feature:IPsec] when using openshift ovn-kubernetes ensure traffic between local pod to a remote pod is not IPsec encrypted when IPsec is Disabled [apigroup:config.openshift.io] [Suite:openshift/network/ipsec]": "",

	"[sig-network][Feature:IPsec] when using openshift ovn-kubernetes ensure traffic between local pod to a remote pod is not IPsec encrypted when IPsecMode configured in External mode [apigroup:config.openshift.io] [Suite:openshift/network/ipsec]": "",
